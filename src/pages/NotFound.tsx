...
const NotFound = () => {
  return (
    <div className="h-screen flex justify-center items-center p-10 bg-sky-50 dark:bg-gray-800">
      <div>
        <img src={notFound} alt="Page not found" className="h-[150px] md:h-[200px]" />
