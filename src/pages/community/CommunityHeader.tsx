...
const CommunityHeader = () => {
  ...
  return (
    ...
    <div className="col-span-5 bg-brand bg-opacity-25 hidden lg:block">
      <div className="p-6 h-full flex items-center justify-center">
        <img src={communityImg} alt="Community" />
      </div>
    </div>
    <div className="col-span-12 lg:col-span-7">
      <div className="bg-brand bg-opacity-10 h-full p-5 md:p-8">
        <h2 className='font-extrabold text-xl md:text-2xl mb-3'>We value your opinion</h2>
        <p className='text-sm md:text-base'>Gratitude doesn't seem enough to express our appreciation for the medical teams and supply providers who stood by us during the aftermath of the disaster. Your unwavering commitment to our well-being restored our faith in humanity. Thank you from the bottom of our hearts </p>
